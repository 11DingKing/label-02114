...
export const updateOrderStatus = (id, status) =>
  request.put(`/order/status/${id}`, null, { params: { status } });
...
export const updateWishlistStatus = (id, status) =>
  request.put(`/wishlist/status/${id}`, null, { params: { status } });

// 每日情话
export const getDailyMessageList = (params) =>
  request.get("/daily-message/list", { params });
export const getDailyMessageById = (id) => request.get(`/daily-message/${id}`);
export const saveDailyMessage = (data) =>
  request.post("/daily-message/save", data);
export const deleteDailyMessage = (id) =>
  request.delete(`/daily-message/${id}`);
